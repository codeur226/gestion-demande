...
<html lang="en">
  <head>
    ...
    <title>Platefrome de demande de stages et d'emplois</title>
  ...
  <script src="{{ asset('front-office/assets/js/plugins.min.js') }}"></script>
  <script src="{{ asset('front-office/assets/js/app.min.js') }}"></script>
